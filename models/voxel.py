...
class BackBone(nn.Module):
    ...
    def __init__(self, block, num_block, geom, use_bn=True):
        ...
        self.deconv3 = nn.ConvTranspose2d(96, 96, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.deconv4 = nn.ConvTranspose2d(96, 160, kernel_size=3, stride=2, padding=1, output_padding=1)
